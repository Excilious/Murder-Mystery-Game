...
RenderMap = [
    ...
    [1,_,_,_,_,_,_,_,_,_,1,1,1,1],
    [1,_,1,1,1,_,_,_,_,_,1,1,1,1],
    [1,_,1,1,1,_,_,_,_,_,_,_,1,1],
    [1,_,1,1,1,_,_,1,1,_,1,_,1,1],
    [1,_,_,_,_,_,_,1,1,_,1,_,1,1],
    [1,_,_,_,_,_,_,1,1,_,1,_,1,1],
...
class Raycasting:
    ...
    def Ray_Cast(self):
        ...
        for ray in range(NumberOfRaycasts):
            ...
            Colour = [248 / (1 + Depth ** 5 * 0.00002)] * 3
